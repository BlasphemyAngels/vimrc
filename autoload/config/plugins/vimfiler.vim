...
function! s:setcolum() abort
  if g:vim_enable_vimfiler_filetypeicon && !g:vim_enable_vimfiler_gitstatus
    return 'filetypeicon'
  elseif !g:vim_enable_vimfiler_filetypeicon && g:vim_enable_vimfiler_gitstatus
    return 'gitstatus'
  elseif g:vim_enable_vimfiler_filetypeicon && g:vim_enable_vimfiler_gitstatus
