...
let g:neomake_error_sign = get(g:, 'neomake_error_sign', {
      \ 'text': get(g:, 'vim_error_symbol', '✖'),
      \ 'texthl': (g:vim_colorscheme ==# 'gruvbox' ? 'GruvboxRedSign' : 'error'),
      \ })
let g:neomake_warning_sign = get(g:, 'neomake_warning_sign', {
      \ 'text': get(g:,'vim_warning_symbol', '➤'),
      \ 'texthl': (g:vim_colorscheme ==# 'gruvbox' ? 'GruvboxYellowSign' : 'todo'),
      \ })
" vim:set et sw=2:
