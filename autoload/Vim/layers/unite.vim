function! Vim#layers#unite#plugins() abort
    let plugins = [
...
function! Vim#layers#unite#config() abort
        call Vim#mapping#space#def('nnoremap', ['!'], 'Unite output/shellcmd -no-start-insert', 'shell cmd', 1)
endfunction
