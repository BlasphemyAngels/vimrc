...
"
" and set 'g:vim_layer_lang_java_formatter' to the path of the jar.


function! Vim#layers#lang#java#plugins() abort
  let plugins = [
...
function! Vim#layers#lang#java#config() abort
  call Vim#mapping#space#regesit_lang_mappings('java', funcref('s:language_specified_mappings'))
  augroup Vim_lang_java
    au!
  ...
  let g:neoformat_java_googlefmt = {
        \ 'exe': 'java',
        \ 'args': ['-jar', get(g:,'vim_layer_lang_java_formatter', '')],
        \ 'replace': 0,
        \ 'stdin': 0,
        \ 'no_append': 0,
        \ }
...
function! s:language_specified_mappings() abort
  ...
  " Import key bindings
  call Vim#mapping#space#langSPC('nmap', ['l','I'],
        \ '<Plug>(JavaComplete-Imports-AddMissing)',
        \ 'Import missing classes', 0)
  call Vim#mapping#space#langSPC('nmap', ['l','R'],
  ...
  call Vim#mapping#space#langSPC('nmap', ['l','A'],
        \ '<Plug>(JavaComplete-Generate-Accessors)',
        \ 'generate setter accessor', 0)
  call Vim#mapping#space#langSPC('nmap', ['l','s'],
        \ '<Plug>(JavaComplete-Generate-AccessorSetter)',
        \ 'generate setter accessor', 0)
  call Vim#mapping#space#langSPC('nmap', ['l','g'],
  ...
  call Vim#mapping#space#langSPC('nmap', ['l','M'],
        \ '<Plug>(JavaComplete-Generate-AbstractMethods)',
        \ 'Generate abstract methods', 0)
  call Vim#mapping#space#langSPC('nmap', ['l','c'],
  ...
  call Vim#mapping#space#langSPC('nmap', ['l','eq'],
        \ '<Plug>(JavaComplete-Generate-EqualsAndHashCode)',
        \ 'Generate equals functions', 0)
  call Vim#mapping#space#langSPC('nmap', ['l','ts'],
        \ '<Plug>(JavaComplete-Generate-ToString)',
        \ 'Generate toString function', 0)

  " Jump
  let g:_vim_mappings_space.l.j = {'name' : '+Jump'}
  call Vim#mapping#space#langSPC('nnoremap', ['l','j', 'a'], 'call call('
        \ . string(function('s:jump_to_alternate')) . ', [])',
        \ 'jump to alternate file', 1)

  " execute
  let g:_vim_mappings_space.l.r = {'name' : '+Run'}
  " run main methon
  call Vim#mapping#space#langSPC('nmap', ['l','r', 'm'], 'JavaUnitTestMain', 'Run main method', 1)
  call Vim#mapping#space#langSPC('nmap', ['l','r', 'c'], 'JavaUnitExec', 'Run current method', 1)
  call Vim#mapping#space#langSPC('nmap', ['l','r', 'a'], 'JavaUnitTestAll', 'Run all test methods', 1)

  " debug
  let g:_vim_mappings_space.l.d = {'name' : '+Debug'}
  " maven
  let g:_vim_mappings_space.l.m = {'name' : '+Maven'}
  call Vim#mapping#space#langSPC('nnoremap', ['l','m', 'i'], 'call call('
        \ . string(function('s:execCMD')) . ', ["mvn clean install"])',
        \ 'Run maven clean install', 1)
  call Vim#mapping#space#langSPC('nnoremap', ['l','m', 'I'], 'call call('
        \ . string(function('s:execCMD')) . ', ["mvn install"])',
        \ 'Run maven install', 1)
  call Vim#mapping#space#langSPC('nnoremap', ['l','m', 't'], 'call call('
