function! Vim#layers#tools#plugins() abort
  return [
...
function! Vim#layers#tools#config() abort
  let g:better_whitespace_filetypes_blacklist = ['diff', 'gitcommit', 'unite', 'qf', 'help', 'markdown', 'leaderGuide']
  call Vim#mapping#space#def('nnoremap', ['a', 'c'], 'Calendar', 'vim calendar', 1)
  call Vim#mapping#space#def('nnoremap', ['e', 'a'], 'FencAutoDetect',
