let s:TAB = Vim#api#import('vim#tab')
...
function! Vim#plugins#windowsmanager#UpdateRestoreWinInfo() abort
    if !&buflisted
        return
    endif
    let s:unmarked = 1
...
function! Vim#plugins#windowsmanager#UndoQuitWin()
...
function! Vim#plugins#windowsmanager#RedoQuitWin()
...
function! Vim#plugins#windowsmanager#MarkBaseWin()
    if s:unmarked
