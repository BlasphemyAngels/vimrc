let s:KEY = Vim#api#import('vim#key')
let s:key_describ = {}

function! Vim#plugins#help#describe_bindings()
endfunction

function! Vim#plugins#help#regist_root(dict)
...
function! Vim#plugins#help#describe_key()
    let definded = 1
