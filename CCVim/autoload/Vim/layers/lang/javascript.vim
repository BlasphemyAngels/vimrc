function! Vim#layers#lang#javascript#plugins() abort
  let plugins = []
...
function! Vim#layers#lang#javascript#config() abort
  call Vim#mapping#gd#add('javascript', function('s:gotodef'))
endfunction
