...
function! Vim#layers#ui#plugins() abort
    let plugins = [
                \ ['Yggdroot/indentLine'],
                \ ['mhinz/vim-signify'],
                ...
                \ ]
    if get(g:, '_vim_statusline_loaded', 0) == 0
...
function! Vim#layers#ui#config() abort
    ...
    " Ui toggles
    call Vim#mapping#space#def('nnoremap', ['t', '8'], 'call call('
                \ . string(s:_function('s:toggle_fill_column')) . ', [])',
                \ 'toggle-colorcolume', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 'b'], 'call ToggleBG()',
                \ 'toggle background', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 't'], 'call Vim#plugins#tabmanager#open()',
                \ 'Open tabs manager', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 'f'], 'call call('
                \ . string(s:_function('s:toggle_colorcolumn')) . ', [])',
                \ 'toggle-colorcolume', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 'h', 'h'], 'set cursorline!',
                \ 'toggle highlight of the current line', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 'h', 'i'], 'call call('
                \ . string(s:_function('s:toggle_indentline')) . ', [])',
                \ 'toggle highlight indentation levels', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 'h', 'c'], 'set cursorcolumn!',
                \ 'toggle highlight indentation current column', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 'h', 's'], 'call call('
                \ . string(s:_function('s:toggle_syntax_hi')) . ', [])',
                \ 'toggle syntax highlighting', 1)

    call Vim#mapping#space#def('nnoremap', ['T', 'F'], '<F11>',
                \ 'fullscreen-frame', 0)
    call Vim#mapping#space#def('nnoremap', ['T', 'm'], 'call call('
                \ . string(s:_function('s:toggle_menu_bar')) . ', [])',
                \ 'toggle-menu-bar', 1)
    call Vim#mapping#space#def('nnoremap', ['T', 'f'], 'call call('
                \ . string(s:_function('s:toggle_win_fringe')) . ', [])',
                \ 'toggle-win-fringe', 1)
    call Vim#mapping#space#def('nnoremap', ['T', 't'], 'call call('
                \ . string(s:_function('s:toggle_tool_bar')) . ', [])',
                \ 'toggle-tool-bar', 1)
    call Vim#mapping#space#def('nnoremap', ['T', '~'], 'call call('
                \ . string(s:_function('s:toggle_end_of_buffer')) . ', [])',
                \ 'display ~ in the fringe on empty lines', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 's'], 'call call('
                \ . string(s:_function('s:toggle_syntax_checker')) . ', [])',
                \ 'toggle syntax checker', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 'S'], 'call call('
                \ . string(s:_function('s:toggle_spell_check')) . ', [])',
                \ 'toggle syntax checker', 1)
    call Vim#mapping#space#def('nnoremap', ['t', 'w'], 'call call('
...
function! s:toggle_colorcolumn() abort
    ...
    call Vim#layers#core#statusline#toggle_mode('fill-column-indicator')
endfunction
...
function! s:toggle_fill_column() abort
    ...
    call Vim#layers#core#statusline#toggle_mode('hi-characters-for-long-lines')
endfunction
...
function! s:toggle_syntax_checker() abort
    call Vim#layers#core#statusline#toggle_section('syntax checking')
    call Vim#layers#core#statusline#toggle_mode('syntax-checking')
    let g:_vim_toggle_syntax_flag = g:_vim_toggle_syntax_flag * -1
    if g:_vim_toggle_syntax_flag == 1
...
function! s:toggle_spell_check() abort
    ...
    call Vim#layers#core#statusline#toggle_mode('spell-checking')
endfunction

function! s:toggle_whitespace() abort
    call Vim#layers#core#statusline#toggle_section('whitespace')
    call Vim#layers#core#statusline#toggle_mode('whitespace')
endfunction
