...
" `Vim#layers#load('tmux')` to your `~/.Vim.d/init.vim`.
" This layer currently overwrites some Vim keybinds including multiple
...
function! Vim#layers#tmux#plugins() abort
    let plugins = []
    call add(plugins,['christoomey/vim-tmux-navigator', {'merged' : 0}])
    return plugins
endfunction

function! Vim#layers#tmux#config() abort
    let g:tmux_navigator_no_mappings = 1
    augroup vim_layer_tmux
        au!
